...
class Application(models.Model):
    ...
    role = models.CharField(
        max_length=100, blank=True, default="", verbose_name="希望役割"
    )
    availability = models.CharField(
        max_length=100, blank=True, default="", verbose_name="参加ペース"
    )
    message = models.TextField(blank=True, default="", verbose_name="メッセージ")
    portfolio_url = models.CharField(
        max_length=200, blank=True, default="", verbose_name="ポートフォリオURL"
    )
